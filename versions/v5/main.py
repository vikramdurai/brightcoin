...
c = conn.cursor()
c.execute("CREATE TABLE addresses (balance INT, name STRING)")
c.execute("CREATE TABLE blockchain (parent STRING, msg STRING, hash STRING, nonce INT, _timestamp INT)")
c.execute("CREATE TABLE transactions (sender STRING, receiver STRING, amount INT)")
conn.commit()
conn.close()
